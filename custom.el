(custom-set-variables
 ...
 '(ein:jupyter-server-command "~/.python/bin/jupyter")
 '(ein:jupyter-server-use-subcommand "server")
 '(org-agenda-files '("~/cg/reservotron/nb-notes/current.org"))
 '(package-selected-packages
   '(magit poly-markdown rust-mode golden-ratio pkg-info flycheck origami copilot yari js2-mode mastodon rainbow-mode asdf rubocop robe buttercup adoc-mode screenshot editorconfig quelpa-use-package quelpa grip-mode restclient dockerfile-mode ein multiple-cursors sql-mode dap-mode crystal-mode crysal-mode rails-i18n ruby-end expand-region rspec-mode flyspell-correct-ivy flyspell-correct zenburn-theme yaml-mode which-key web-mode use-package tide svelte-mode smartparens slim-mode scss-mode rvm ruby-electric rjsx-mode rainbow-delimiters projectile-ripgrep projectile-rails lua-mode lsp-ui lsp-treemacs lsp-ivy load-relative json-mode ivy-rich helpful helm-rb helm-projectile helm-ispell haml-mode google-translate geiser-racket find-things-fast emojify emmet-mode elm-mode elixir-mix elisp-lint dumb-jump doom-themes doom-modeline direnv counsel-projectile company-web company-tabnine company-go company-box coffee-mode cl-libify autopair auto-dim-other-buffers all-the-icons alchemist))
